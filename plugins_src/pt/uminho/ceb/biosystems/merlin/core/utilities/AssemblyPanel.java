...
import pt.uminho.ceb.biosystems.merlin.core.gui.DownloadNcbiFilesGUI;
import pt.uminho.ceb.biosystems.merlin.core.gui.NewProjectGui;
	...
	public void updateTextArea(String assemblyName){
		...
		try {
			if(assemblyName.equals("don't download")){
				NewProjectGui.toImport = false;
				jPanel2.setVisible(false);
				DownloadNcbiFilesGUI.toImport = false;
			}
				...
				NewProjectGui.toImport = true;	
				DownloadNcbiFilesGUI.toImport = true;
			}
