...
public class StarColumn {
		...
		private Map<Integer, Integer> starsReviewedMap;
		...
		private JXButton createButton(Object value, int row) {
			...
			this.starsReviewedMap.put(row, Integer.parseInt((String)value));
		 ...
		 */
		public Map<Integer, Integer> getStarsReviewedMap() {
		 ...
		 */
		public void setStarsReviewedMap(Map<Integer, Integer> starsReviewedMap) {
