...
public class IntegrationReport {
	 ...
	 * @param enzymes
	 */
	public void saveEnzymesReport(String database, Map<String, Set<String>> existingEnzymes , Map<String, Set<String>> homologyEnzymesData, Map<String, Set<String>> integratedEnzymes,  String path){
	...
	public void pathwaysIntegrationReport(String database, Map<String,Set<String>> allPathways, Map<String,Set<String>> exists, Map<String,Set<String>> homologyEnzymesData, String dirPath) {
		...
		{//complete pathways
			...
			this.createFile(database, "/Complete_Pathways.xls", strInput, dirPath);
		}
		...
		{//complete pathways
			...
			this.createFile(database, "/Incomplete_Pathways.xls", strInput, dirPath);
		}
		...
		this.createFile(database, "/New_Pathway.xls", strInput, dirPath);
		...
		this.createFile(database, "/New_enzymes.xls", strInput, dirPath);
		...
		this.createFile(database, "/Existing_enzymes.xls", strInput, dirPath);
	}
