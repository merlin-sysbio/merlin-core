...
public class LoadKeggAnnotationGUI extends javax.swing.JDialog implements InputGUI {
			...
			button1.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent evt) {
					...
					if (projects.length != 0) {
						...
						// {
						//
						// Workbench.getInstance().info("No organism related
						// information will be loaded!");
						// }

						rec.paramsIntroduced(
								new ParamSpec[] { new ParamSpec("Workspace", Project.class, projectData, null),
	 ...
	 * 
	 */
	private void updateComboBox(Project projectData) {
