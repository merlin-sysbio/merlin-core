...
public class EnzymesAnnotationGUI extends javax.swing.JDialog {
	 ...
	 */
	public EnzymesAnnotationGUI(String blastDatabase, int sampleSize, int ecnumbersColumnNumber, int ecScoreColumnNumber, Map<Integer, String> values, Map<Integer, String> itemsList, 
			int locus_tagColumnNumber, DataTable data, EnzymesAnnotationDataInterface homologyDataContainer, Map<Integer,String> ecMap) {
							...
							public void actionPerformed(ActionEvent arg0) {
								...
								try {
									...
									for (@SuppressWarnings("rawtypes") OperationDefinition def : Core.getInstance().getOperations()){
										if (def.getID().equals("operations.BestAlpha.ID")){
							...
							public void actionPerformed(ActionEvent arg0) {
								...
								try {
									...
									if (returnVal == JFileChooser.APPROVE_OPTION) {
										...
										String name = homologyDataContainer.getProject().getDatabase().getDatabaseName();
										
										excelFileName += "/"+name+"_"+hour24+"_"+min+"_"+day+".xls";
										...
										DataTable table = createTableToExport();
...
//			e.printStackTrace();
	 ...
	 * @return DataTable
	 */
	private DataTable createTableToExport(){
