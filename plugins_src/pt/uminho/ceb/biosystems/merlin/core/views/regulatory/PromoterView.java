...
import pt.uminho.ceb.biosystems.merlin.core.datatypes.regulatory.Promoter;
...
public class PromoterView extends javax.swing.JPanel {
	...
	public PromoterView(Promoter e) {
		super();
		this.e = e;
	...
	private void initGUI() {
		try {
			...
			jPanel1Layout.rowHeights = new int[] {7, 50, 7, 3, 7};			this.setLayout(jPanel1Layout);
			...
			this.add(jPanel2, c);
			{
				...
				jPanel3.setLayout(null);
				{
					...
					jRadioButton1.setText("Regulations");
				}
				{
					jRadioButton3 = new JRadioButton();
					jPanel3.add(jRadioButton3);
					jRadioButton3.setText("TUs");
				}
				...
				jRadioButton3.setBounds(17, 47, 124, 18);
			...
			ComboBoxModel searchComboBoxModel = new DefaultComboBoxModel(this.e.getSearchDataIds());
			...
			jPanel4.setBounds(30, 26, 676, 34);
			{
				...
				jButton1ExportTxt.setBounds(546, 72, 161, 38);
				jButton1ExportTxt.addActionListener(new ActionListener()
				{
					public void actionPerformed(ActionEvent arg0) 
					{
						String[][] results = SaveToTxt.qrtableToMatrix(querydata);
						String file = "C:\\Promoters.txt"; 
						try {
						//	SaveToTxt.save_matrix(file, results, "Promoters");
						} catch (Exception e) {
	...
	{
		try {
			if(this.jRadioButton1.isSelected()) this.e.setSort(2);
			else if(this.jRadioButton3.isSelected()) this.e.setSort(4);
