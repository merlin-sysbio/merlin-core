...
public class GenericDetailWindow extends javax.swing.JDialog {
	 ...
	 * @param reaction
	 */
	public GenericDetailWindow(DataTable[] dataTable, String windowName, String name, String reaction) {
	 ...
	 * @param name
	 */
	public GenericDetailWindow(DataTable[] querydatas, String windowName, String name) {
	 ...
	 * @param name
	 */
	private void initGUI(DataTable[] querydatas, String windowName, String name) {
