...
import pt.uminho.ceb.biosystems.merlin.core.gui.InsertEditMetabolite;
 ...
 * 
 */
public class ReactantsProductsView extends UpdatablePanel {
	 ...
	 * @param rp
	 */
	public ReactantsProductsView(ReactantsProducts rp) {

		super(rp);
		this.reactantsProducts = rp;
				...
				jPanelInsertEdit.setBorder(BorderFactory.createTitledBorder("insert/edit/remove"));
				{
					...
					jButtonInsert.addActionListener( new ActionListener(){
						...
						public void actionPerformed(ActionEvent e) {
							...
							new InsertEditMetabolite(-1, "", "", reactantsProducts);
							fillList(jRadioButtonEncoded.isSelected());
					...
					jButtonEdit.addActionListener( new ActionListener(){
						...
						public void actionPerformed(ActionEvent e) {
							...
							if(jTable.getSelectedRow()>-1) {
								...
								new InsertEditMetabolite(row, metaboliteName, keggID, reactantsProducts);
					...
					jButtonRemove.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							...
							if(jTable.getSelectedRow()>-1) {
								...
								ArrayList<String> reactions = reactantsProducts.getRelatedReactions(metaboliteName);
								...
								if (reactions.size() > 0){
									...
									if (discard){
										reactantsProducts.deleteMetabolite(metaboliteKeggID);
										fillList(jRadioButtonEncoded.isSelected());
									}
								}
...
//		jScrollPane1.setViewportView(jTable);
		...
		if(count==0)
			...
			if (jRadioButton1.isSelected())
				dataTable = this.reactantsProducts.getDataReagentProduct(1, encoded, types);
			else if (jRadioButton2.isSelected())
				dataTable = this.reactantsProducts.getDataReagentProduct(2, encoded, types);
			else 	
				dataTable = this.reactantsProducts.getDataReagentProduct(3, encoded, types);
		}
	...
	private void processButton(EventObject arg0) {
		...
		DataTable[] table = reactantsProducts.getReaction(selectedRowID, (String) jTable.getValueAt(jTable.getSelectedRow(), 2));
	...
	private boolean discardData(String name, ArrayList<String> reactions) {
