package pt.uminho.ceb.biosystems.merlin.core.views.windows;
...
import pt.uminho.ceb.biosystems.merlin.core.utilities.TextAreaEditor;
import pt.uminho.ceb.biosystems.merlin.core.utilities.TextAreaRenderer;
...
public class GenericDetailWindowBlast extends javax.swing.JDialog implements Serializable{
	 ...
	 * @param name
	 */
	public GenericDetailWindowBlast(DataTable[] dataTable, String windowName, String name) {
	...
	private void searchComboBoxActionPerformed(ActionEvent evt) {
		...
		DataTable data = this.dataTable[this.searchComboBox.getSelectedIndex()];
...
//		if(this.searchComboBox.getSelectedIndex()==0 || (this.dataTable.length>4 && this.searchComboBox.getSelectedIndex()==2))			
	...
	private void addLinkOutsListener(MouseEvent arg0) {
		...
		if(searchComboBox.getSelectedItem().toString().contains("Homology") && !searchComboBox.getSelectedItem().toString().contains("InterPro") &&  jTable.getSelectedColumn()==(new Integer(2))) {
//			if((searchComboBox.getSelectedIndex()==0 || (this.dataTable.length>4 && searchComboBox.getSelectedIndex()==2)) && (jTable.getSelectedColumn()==(new Integer(2)))) {
		...
		if(searchComboBox.getSelectedItem().toString().contains("Homology") && !searchComboBox.getSelectedItem().toString().contains("InterPro") &&  jTable.getSelectedColumn()==(new Integer(1))) {
