...
import pt.uminho.ceb.biosystems.merlin.core.gui.EnzymesAnnotationGUI;
...
//	public EnzymesAnnotationParametersSetting(, int locus_tagColumnNumber, int ecnumbersColumnNumber, int ecScoreColumnNumber){
		...
		public void setSearchFile(boolean searchFile){
			...
			if(!this.cancel.get())
				new EnzymesAnnotationGUI(this.blastDatabase, sampleSize, ecnumbersColumnNumber, ecScoreColumnNumber, values, 
